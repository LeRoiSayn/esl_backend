        ...
        <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#1e3a5f 0%,#2d6a9f 100%);padding:32px 40px;text-align:center;">
              <img src="<?php echo e($message->embed($logoPath)); ?>" alt="ESL" width="80" height="80"
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              <p style="margin:0 0 8px;color:#374151;font-size:15px;">Bonjour <strong><?php echo e($user->first_name); ?></strong>,</p>
              ...
              <div style="text-align:center;margin:32px 0;">
                <div style="display:inline-block;background:#f0f7ff;border:2px dashed #2d6a9f;border-radius:12px;padding:20px 40px;">
                  ...
                  <p style="margin:0;color:#1e3a5f;font-size:40px;font-weight:800;letter-spacing:12px;font-family:monospace;"><?php echo e($code); ?></p>
                </div>
              </div>
          ...
          <tr>
            <td style="background:#f9fafb;padding:20px 40px;text-align:center;border-top:1px solid #e5e7eb;">
              <p style="margin:0;color:#9ca3af;font-size:11px;">
                © <?php echo e(date('Y')); ?> ESL — School of Health of Libreville. Tous droits réservés.
              </p>
            </td>
          </tr>
...
<?php /**PATH /Users/macbookpro/Documents/Unilak/FYP/ESL2/backend/resources/views/emails/otp.blade.php ENDPATH**/ ?>